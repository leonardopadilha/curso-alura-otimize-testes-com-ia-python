...
def gerar_script_teste(cenario_teste, documento, dicionario_arquivos, assistente, thread, modelo=MODELO_GPT_4):
    usuarios_teste = criar_usuarios_teste(cenario_teste, documento, dicionario_arquivos)
    ...
    pergunta = f"""
            ...
            Considere também inserir quatro (4) casos de teste, utilizando os resultados de {usuarios_teste}. Faça as
            iterações em um laço de repetição, mostrando ao final "Aprovado" se o teste logar e logou ou deveria
            falhar e falhou.
