...
def gerar_script_teste(caso_uso, cenario_teste):
    ...
    prompt_sistema = f"""
        ...
        Seu cenário de teste deve fornecer uma script em Selenium e deve utilizar o chromium como driver para 
        isso. Além disso, seu código deve ser escrito em Python e deve utilizar apenas as bibliotecas em destaque.
