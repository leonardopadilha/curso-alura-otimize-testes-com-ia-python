...
options= Options()
options.headless = False  # Executa o Chrome em modo headless
service = Service('driver/chromedriver.exe')  # Substitua pelo caminho do seu ChromeDriver
...
for test_case in test_cases:
    ...
    driver.get('https://almsantana.github.io/')  # Substitua pelo caminho do arquivo index.html
